...
static_assert(std::is_same_v<decltype(std::declval<Client>().timeSyncRtkStatus()), prism::TimeSyncRtkStatus>);
static_assert(std::is_same_v<decltype(std::declval<Client>().timeSyncCorsConfiguration()), prism::TimeSyncCorsStatus>);
static_assert(std::is_same_v<decltype(std::declval<Client>().startRtk()), prism::TimeSyncRtkStatus>);
static_assert(std::is_same_v<decltype(std::declval<Client>().stopRtk()), prism::TimeSyncRtkStatus>);
